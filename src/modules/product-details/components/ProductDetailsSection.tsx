import { TProductDetailsSectionProps } from "./ProductDetailsSection.types";

const ProductDetailsSection = (props: TProductDetailsSectionProps) => {
  return (
    <article className="py-3 px-5 md:py-6 md:px-10">
      ...
      <p className="text-slate-gray font-medium mb-3">
        Categories:{" "}
        {props.product.categories.map((category: { name: string }) => category.name).join(", ")}
      </p>
      <p className="text-slate-gray font-medium mb-3">
